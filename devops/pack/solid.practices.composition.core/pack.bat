...
robocopy ../../../../../Bin/netstandard/Release netstandard2.0 Solid.Practices.Composition.Contracts.* /E
robocopy ../../../../../Bin/netstandard/Release netstandard2.0 Solid.Practices.Composition.Container.* /E
